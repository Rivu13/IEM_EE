...
export const awards = [
  ...
  {
    id: 'football-runner-up-2025',
    title: 'Runner-Up in IEM Inter Department Football Tournament 2025!',
    images: imageRange('award', 3, 1),
    paragraphs: [
      'Proud to share that our Electrical Engineering Department team finished as the Runner-Up in the IEM Inter Department Football Tournament 2025! It was an incredible journey filled with teamwork, determination, and passion for the game.',
    ],
  },
  {
    id: 'effi-cycle',
    title: 'Team CYGNUS ranked AIR 2 in Effi-Cycle 2024 at Lovely Professional University, Punjab',
    images: imageRange('award', 4, 3),
    paragraphs: ['IEM Electrical Department Team has ranked AIR 2 in Effi-Cycle.'],
  },
  {
    id: 'football-champion-2024',
    title: 'Champion in the Inter-Departmental Football Tournament 2024',
    images: imageRange('award', 7, 1),
    paragraphs: [
      'IEM Electrical Department Team has bagged the 1st Position in the Inter-Departmental Football Tournament 2024.',
    ],
  },
  {
  ...
  {
    id: 'chhatra-vishwakarma',
    title: 'AICTE National Level Chhatra Vishwakarma Awards 2020',
    images: imageRange('award', 9, 4),
    paragraphs: [
      'SOUHRIDYA BHATTACHARJEE Team-Frontliner, of EE 2018-22 batch is awarded with 3rd Prize in the category "Working Conditions; Ensuring Occupational Health and Safety Issues" for presenting a prototype/ innovative solution of "Four in One SMART MASK" under the theme "India\'s Economic Recovery Post Covid; Reverse Migration and Rehabilitation Plan" to support "Atmanirbhar Bharat".',
    ],
  },
  {
